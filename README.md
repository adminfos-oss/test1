...
Cоздана UML-диаграмма классов, которая отражает все ключевые модели и их отношения. Диаграмма разработана с учетом принципов нормализации и обеспечивает целостность данных.
